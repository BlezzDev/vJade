...
vJade is a framework that allows you to create and configure applications/games (for now only for PC but I plan to expand it to other platforms if possible) powered by modern OpenGL (3.3) thanks to LWJGL
